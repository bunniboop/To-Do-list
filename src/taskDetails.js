...
import { cancelButtonHandler, completeHandler, addToProgressBar } from "./buttons.js";
...
export function addNewTask(conteinderEl) {
    ...
    // render(taksTemplate, todoContainer)
...
`
    render(taksTemplate(taskTittleInput, container, completedContainer ), container);
