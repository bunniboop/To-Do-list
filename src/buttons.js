...
function addNewTask(conteinderid){
    const todoContainer = document.getElementById(conteinderid);
...
function makeElement({type, content, className, idName, _src, inner}){
...
function replaceInput(taskTitle, inputArea ){
...
function createGroup(e){
    ...
    //events
    svgDropMenu.addEventListener('click', function(e){
