...
function addToProgressBar(e) {
    ...
    const tasksConatiner = confirmButton.parentElement.parentElement.parentElement // <-- dont ever do this again
    const progresBarr =  tasksConatiner.nextSibling 
    changeToChecked(confirmButton);
    confirmButton.disabled = true;

    console.log(tasksConatiner, progresBarr);
